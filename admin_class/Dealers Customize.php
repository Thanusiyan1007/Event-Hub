...
<html>
    ...
    <body>
        ...
        <div class="Deaers-Customize-Container">
            ...
            <table>
                ...
                <tbody>
                    ...
                    try {
                        ...
                        $query = "SELECT * FROM `user` WHERE `role` = 'business'";
                        ...
                        foreach ($rs as $user) {
                            ...
                            <tr>
                                ...
                                <td><?php echo $user->BusinessType; ?></td>
                                <td><a href="Delete_Dealers_Customize.php?id=<?php echo $user->Id; ?>"><button>Delete Dealer</button></a></td>
                            </tr>
                            <?php
                            $i++;
                        }
